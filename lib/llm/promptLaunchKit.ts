...
Your job is to produce a complete launch kit for a HAMR launchpad token on Robinhood Chain, ready for the human team to review and sign.
...
2. NEVER claim official partnership or endorsement from xAI, X, Grok, HAMR launchpad, Robinhood, Uniswap, or any third party.
